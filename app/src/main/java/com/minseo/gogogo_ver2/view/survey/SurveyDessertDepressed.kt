...
class SurveyDessertDepressed : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                Navigation.findNavController(binding.root).navigate(R.id.action_surveyDessertDepressed_to_surveyStart1)
            }
        }
    ...
    fun pickHot() {
        ...
        findNavController().navigate(R.id.action_surveyDessertDepressed_to_roulette)
    }
